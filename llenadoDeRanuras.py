...
def semantic_network_animals():
   ...
   for characteristic in characteristics_to_query:
      ...
      print(f"Animales con la característica '{Style.BRIGHT + characteristic + Fore.YELLOW}': {found_animals}")
...
def conceptual_dependency():
   ...
   for oracion in oraciones:
      ...
      if accion:
         ...
         if accion == 'ATRANS':
            print(f"{Style.BRIGHT + Fore.YELLOW + actor + Fore.BLUE} transfirió objeto a {Fore.GREEN + receptor}")
         elif accion == 'MTRANS':
            print(f"{Style.BRIGHT + Fore.YELLOW + actor + Fore.BLUE} transfirió información a {Fore.GREEN + receptor}")
         elif accion == 'PROPEL':
            print(f"{Style.BRIGHT + Fore.YELLOW + actor + Fore.BLUE} aplicó fuerza a {Fore.GREEN + receptor}")
         elif accion == 'GRASP':
            print(f"{Style.BRIGHT + Fore.YELLOW + actor + Fore.BLUE} sostuvo objeto de {Fore.GREEN + receptor}")
      else:
         print(Fore.RED + "No se pudo identificar la acción en la oración: " + oracion)
   print()
...
def frames_medical_diagnostics():
   ...
   for nombre, sintomas in pacientes.items():
      ...
      print(f"{nombre}: Diagnóstico sugerido -> {Style.BRIGHT + Fore.MAGENTA + diagnostico}")
   print()
...
def main():
   ...
   while True:
      ...
      print(Style.BRIGHT + Fore.YELLOW + "///////////////////   Unidad 3. Conocimiento  ///////////////////")
