...
def xg_difuso(CSV):
    if CSV == None:
        ...
        print(Colores.CIAN_CLARO + "Usando datos de ejemplo." + Colores.DEFAULT)
    else:
        try:
            df = pd.read_csv(CSV)
            df.columns = df.columns.str.strip()
            print(Colores.CIAN_CLARO + "Archivo cargado correctamente y columnas limpiadas." + Colores.DEFAULT)
